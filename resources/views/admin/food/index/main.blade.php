...
<table id="indextable" class="table is-fullwidth is-narrow is-bordered is-striped">
    ...
    <tbody>
        ...
        <tr id="row-<?= $id ?>" class="{{ $row['bgcolor'] }}">
            <td id="d-ctrl-<?= $id ?>">
                <a id="act-detail-{{ $id }}" href="{{ route('admin-food-detail', ['food_id' => $id]) }}" class="button is-small">詳細</a>
            ...
            <td id="d-category-<?= $id ?>" class="d-category val d-none"><?= (new \App\L\FoodCategory())->label($row["category"]) ?></td>
